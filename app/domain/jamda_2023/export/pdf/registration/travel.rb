      ...
      def list
        ...
        pdf.indent(10) do
          ...
          pdf.indent(10) do
            ...
            +' CMT ab Herbst 2021 unter Berücksichtigung der Wünsche der Teilnehmenden'\
            +' vorgenommen.'
          ...
          pdf.move_down 3.mm
          text 'b) CMT (KT), Kontingentsleitung (KL + eKL) und International Service'\
          +' Team (IST)', size: 10
          pdf.move_down 1.mm
          pdf.indent(10) do
            text 'Für CMT und ISTs finden Vor- und/oder Nachprogramm sowie die An- und'\
        ...
        +' CMTmitglied oder als Mitglied des International Service'\
